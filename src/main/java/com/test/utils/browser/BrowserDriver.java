...
public class BrowserDriver implements WebDriver, JavascriptExecutor, TakesScreenshot, HasInputDevices {
     ...
     * Default constructor.
     *
     * @param driver Selenium WebDirver object to delegate to.
     */
    ...
    public Keyboard getKeyboard() {
        Keyboard keyboard = ((HasInputDevices) this.webDriver).getKeyboard();
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public Mouse getMouse() {
        Mouse mouse = ((HasInputDevices) this.webDriver).getMouse();
